...
class PdfLoader:
    ...
    def extract_bytes(self,firstPage:int=1,lastPage:int=0,fixedPitch:float=0) -> List[bytes]: ...
    def extract_strings(self,firstPage:int=1,lastPage:int=0,fixedPitch:float=0) -> List[str]: ...
    def extract_bytes_area(self,marginl: int=0,marginr: int=0,margint: int=0,marginb: int=0) -> npt.NDArray[Any]: ...
    def extract_strings_area(self,marginl: int=0,marginr: int=0,margint: int=0,marginb: int=0) -> npt.NDArray[Any]: ...
